      ...
      <div class="product-holder-content">
        ...
        <div class="product-price-container">
          <div class="price">
            ...
            <div class="old" v-if="this.justProduct.oldPrice">
              $ {{ this.justProduct.oldPrice }}
            </div>
          </div>
          <div class="review">
            <div class="stars">
        ...
        <div class="product-var">
          <div v-if="this.justProduct.size.length > 1">
            ...
            <div class="product-prop-holder">
              <div
                class="product-size"
                v-for="(size, i) in this.justProduct.size"
                :key="i"
                @click="addActive"
              >
                {{ size }}
        ...
        <div v-if="this.justProduct.colors.length > 1">
          <div class="product-var">
            ...
            <div class="product-prop-holder">
              <div
                class="product-color"
                v-for="(color, i) in this.justProduct.colors"
                :key="i"
                :style="{ backgroundColor: color }"
                @click="addActive"
              >
                <font-awesome-icon
                  class="product-color-i"
                  :icon="['fas', 'check']"
                />
              </div>
            </div>
          ...
          <div class="product-var">
            ...
            <div class="product-prop-holder">
              <div
                ...
                v-for="(material, i) in this.justProduct.material"
                :key="i"
                @click="addActive"
              >
                {{ material }}
  ...
  computed: {
    productImg() {
      return {
        ...this.justProduct,
        img:
          this.justProduct.img &&
          require(`@/assets/imgs/${this.justProduct.img}`),
      };
    },
  },
  methods: {
    ...
    sendMyProducts() {
      ...
      this.$store.commit(
        "myProducts",
        Object.assign({}, this.productDescription)
      );
    },
  },
